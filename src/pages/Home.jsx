                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="hidden w-full bg-black md:block md:w-auto" id="navbar-default">
                        <ul className="font-medium flex flex-col bg-black p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-black md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  md: dark:border-gray-700">
                            <li>
                                <a href="/" className="block py-2 px-3 text-red-500 font-bold md:p-0" aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="/Search" className="block py-2 px-3 text-white rounded md:p-0 hover:text-red-500">Explore</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white rounded md:p-0 hover:text-red-500">Genre</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white rounded md:p-0 hover:text-red-500">News</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white rounded md:p-0 hover:text-red-500">Movies</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 px-3 text-white rounded md:p-0 hover:text-red-500">TV Shows</a>
                            </li>
                        </ul>
                    </div>
                </div>
